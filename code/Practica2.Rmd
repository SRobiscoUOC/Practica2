...
Procederemos a eliminar las columnas con valores vacíos, así como variables que no aportan nada.

```{r}
# Eliminar columnas de un dataframe
columnas_borrar <- c("version","release","gps","detector_frame_chirp_mass","detector_frame_chirp_mass_upper","detector_frame_chirp_mass_lower", "tipo")
