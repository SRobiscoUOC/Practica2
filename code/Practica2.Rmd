...
Ahora que hemos descrito los datos de nuestro dataset los conoceremos mejor obteniendo sus estadísticas básicas:
...
Ahora las de valores vacíos, por si los hubiera:
```{r}
colSums(dataset=="")
```
